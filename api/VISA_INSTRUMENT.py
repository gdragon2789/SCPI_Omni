...
from api.TimmingProfile import TimingProfile
...
class VISA_INSTRUMENT:
    def __init__(self, visa_port=None, connection_type=None):
        ...
        self.serial_timing_profile = TimingProfile(write_delay=1, soft_delay=1, query_delay=1)
        self.__connect()
    ...
    def write(self, command: str) -> None:
        ...
        self.timing.sleep_write()

    def query(self, command: str) -> str:
        self.timing.sleep_query()
